...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (codingContainer) {
        ...
        if (loggedInUsn) {
            ...
            // If we're not logged in, the entry form should be visible. We just need to attach its listener.
    ...
    async function loadSingleProblem(problemId) {
        ...
        try {
            ...
            const submissionCallback = () => {
                ...
                if(submitCodeBtn && !submitCodeBtn.disabled) submitCodeBtn.click();
            };
            ...
            submitCodeBtn.addEventListener('click', async (event) => {
                ...
                try {
                    ...
                    if (!submitResponse.ok) {
                        alert(result.message); // Show the "already submitted" message
