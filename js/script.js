// js/script.js (The Truly Final Production Version with Refined Proctoring)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // =======================================================
    // == START: REFINED PROCTORING LOGIC                   ==
    // =======================================================
    ...
    function activateEditorProctoring(editorInstance) {
        ...
        editorInstance.on('beforeChange', (instance, changeObj) => {
            if (changeObj.origin === 'paste') {
                changeObj.cancel();
                if (proctorToast) proctorToast.show();
            }
        });
    }
    ...
    function activatePageProctoring(submissionCallback) {
        ...
        // THE MOUSE-LEAVE HANDLER HAS BEEN REMOVED
        window.proctoringListeners = { visibilityHandler, blurHandler };
    ...
    function deactivateProctoring() {
        if (window.proctoringListeners) {
            ...
            // THE MOUSE-LEAVE REMOVER HAS BEEN REMOVED
            window.proctoringListeners = null;
        }
        clearInterval(problemTimerInterval);
    }
    // =======================================================
    // == END: REFINED PROCTORING LOGIC                     ==
    // =======================================================
