...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- Online Compiler Logic (Multi-Language) ---
    ...
    // --- Coding Problems Logic (with Gatekeeper & Multi-Language) ---
    ...
    async function loadSingleProblem(problemId) {
        ...
        try {
            ...
            const editor = CodeMirror(document.getElementById('codeEditorDiv'), { value: defaultCode.java, mode: "text/x-java", theme: "dracula", lineNumbers: true, autoCloseBrackets: true });
